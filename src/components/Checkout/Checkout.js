...
/*     const [name, setName] = useState('')
    ...
    const createOrder = async(name, phone, email) => {
        ...
        try{
            ...
            const productsRef = query(collection(db, 'ProductData'), where(documentId(), 'in', ids))
    ...
    if(orderId) {
        return (
            ...
            <MyModal show={true} handleClose={handleClose} title='ATENCION' body={`Su orden de compra es: ${orderId}`}
            save='Ok'/>
        )
    }
